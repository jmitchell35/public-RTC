...
pub enum WsEvent {
    ...
    MessagePinned { channel_id: Uuid, message_id: Uuid, pinned: bool },
    ReactionAdded { channel_id: Uuid, message_id: Uuid, reaction: crate::models::MessageReaction },
    ReactionRemoved { channel_id: Uuid, message_id: Uuid, user_id: Uuid, emoji: String },
